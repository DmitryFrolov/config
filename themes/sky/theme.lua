...
theme.bg_normal     = "#000000" -- "#e2eeea00" opacity rekts video driver for VB VM
...
theme.awesome_icon           = "/home/admin-local/.config/awesome/themes/sky/d-icon.png"
...
-- MISC
theme.wallpaper             = "/home/admin-local/.config/awesome/themes/sky/illidan.jpg"
